...
const Animal = require("../models/animal"); // CREATE: Crear un nuevo animal 
...
router.put("/:id", async (req, res) => {
    try {
        const updatedAnimal = await Animal.findByIdAndUpdate(req.params.id, // Buscar el animal por ID 
